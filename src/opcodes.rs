...
pub static CPU_OPS_CODES: LazyLock<Vec<OpCode>> = LazyLock::new(|| {
    vec![
        ...
        OpCode::new(
            ...
            3,
            4,
            /* 5 if page crossed */ AddressingMode::AbsoluteY,
        ),
        ...
        OpCode::new(
            ...
            3,
            4,
            /* 5 if page crossed */ AddressingMode::AbsoluteX,
        ),
        ...
        OpCode::new(0x90, "BCC", 2, 2, AddressingMode::Relative), //  3 if branch taken, 4 if page crossed cycle
...
pub static OPCODES_MAP: LazyLock<HashMap<u8, &'static OpCode>> = LazyLock::new(|| {
    ...
    for cpuop in &*CPU_OPS_CODES {
        map.insert(cpuop.instruction, cpuop);
    }
    map
});
